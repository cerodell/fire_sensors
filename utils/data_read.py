"""
  ...
  to run from the command line::
    ...
    python -m cr507.utils.data_read photon_data.csv

    or

    python -m cr507.utils.data_read *par_9km.nc --root https://oceandata.sci.gsfc.nasa.gov/cgi/getfile --dest_folder=.

  to run from a python script::

    from cr507.utils.data_read import download
...
def read_soundings():
    soundings_folder = cr507.test_dir / Path("soundings")
